...
function sessionValue() {
  ...
  const secret = process.env.SESSION_SECRET || process.env.GITHUB_TOKEN || '';
...
module.exports = { sendJson, safeEqual, sessionValue, authCookie, isAuthenticated, github, readCatalog, writeCatalog, slugify, REPO, BRANCH };